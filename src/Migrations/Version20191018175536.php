 ...
 */
final class Version20191018175536 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__feed AS SELECT id, title, rights, author, icon, subtitle, logo, updated, contributor, generator, last_fetched, url, link FROM feed');
        $this->addSql('DROP TABLE feed');
        $this->addSql('CREATE TABLE feed (id VARCHAR(255) NOT NULL COLLATE BINARY, title VARCHAR(255) NOT NULL COLLATE BINARY, rights VARCHAR(255) DEFAULT NULL COLLATE BINARY, icon VARCHAR(255) DEFAULT NULL COLLATE BINARY, subtitle VARCHAR(255) DEFAULT NULL COLLATE BINARY, logo VARCHAR(255) DEFAULT NULL COLLATE BINARY, updated DATETIME NOT NULL, generator VARCHAR(255) DEFAULT NULL COLLATE BINARY, last_fetched DATETIME DEFAULT NULL, url VARCHAR(255) NOT NULL COLLATE BINARY, author CLOB DEFAULT NULL --(DC2Type:object)
        , contributor CLOB DEFAULT NULL --(DC2Type:object)
        , link CLOB DEFAULT NULL --(DC2Type:object)
        , PRIMARY KEY(id))');
        $this->addSql('INSERT INTO feed (id, title, rights, author, icon, subtitle, logo, updated, contributor, generator, last_fetched, url, link) SELECT id, title, rights, author, icon, subtitle, logo, updated, contributor, generator, last_fetched, url, link FROM __temp__feed');
        ...
        $this->addSql('CREATE TABLE word (word VARCHAR(255) NOT NULL COLLATE BINARY, feed_id VARCHAR(255) DEFAULT NULL COLLATE BINARY, count INTEGER NOT NULL, PRIMARY KEY(word), CONSTRAINT FK_C3F1751151A5BC03 FOREIGN KEY (feed_id) REFERENCES feed (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE feed');
        $this->addSql('CREATE TABLE feed (id VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, rights VARCHAR(255) DEFAULT NULL, icon VARCHAR(255) DEFAULT NULL, subtitle VARCHAR(255) DEFAULT NULL, logo VARCHAR(255) DEFAULT NULL, updated DATETIME NOT NULL, generator VARCHAR(255) DEFAULT NULL, last_fetched DATETIME DEFAULT NULL, url VARCHAR(255) NOT NULL, link CLOB DEFAULT \'NULL --(DC2Type:json)\' COLLATE BINARY --(DC2Type:json)
        , author CLOB DEFAULT NULL COLLATE BINARY --(DC2Type:json)
        , contributor CLOB DEFAULT NULL COLLATE BINARY --(DC2Type:json)
        , PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__word AS SELECT word, feed_id, count FROM word');
        $this->addSql('DROP TABLE word');
        $this->addSql('CREATE TABLE word (word VARCHAR(255) NOT NULL, feed_id VARCHAR(255) DEFAULT NULL, count INTEGER NOT NULL, PRIMARY KEY(word))');
        $this->addSql('INSERT INTO word (word, feed_id, count) SELECT word, feed_id, count FROM __temp__word');
        $this->addSql('DROP TABLE __temp__word');
        $this->addSql('CREATE INDEX IDX_C3F1751151A5BC03 ON word (feed_id)');
    }
